...
<div class="flex justify-center w-auto items-start mt-32 h-screen">
    <div class="max-w-md md:max-w-4xl group md:ml-24 transform hover:scale-105 duration-300 bg-white shadow-xl hover:bg-slate-200 rounded-md p-6">
      <h2 class="text-lg font-semibold mb-4 transition duration-300 group-hover:translate-x-4  transform select-none"> <span class="bg-white py-2 px-4 text-white group-hover:bg-slate-300 group-hover:text-slate-400 rounded-full" >v</span>  Waiting Products</h2>
